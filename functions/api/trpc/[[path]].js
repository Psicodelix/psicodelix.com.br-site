...
// Lógica de oferta personalizada solicitada
function getOffer(usesMedication) {
  if (usesMedication) {
    // Se usa remédios ou drogas: MED, DESS e NEXUS
    return ['MED', 'DESS', 'NEXUS'];
  } else {
    // Se não usa remédios: MED, ELEVE e NEXUS
    return ['MED', 'ELEVE', 'NEXUS'];
  }
}
...
const PROTOCOLS = {
  MED: {
    ...
    features: [
      'Acesso 24/7 ao protocolo completo',
      'IA treinada em psicoterapia avançada',
      'Exercícios e práticas diárias personalizadas',
      'Monitoramento de progresso em tempo real',
      'Material educativo científico completo',
      'Suporte por chat com especialistas',
  ...
  ELEVE: {
    ...
    features: [
      ...
      'Consultas com Psicoterapeuta Credenciado',
      'Consulta em vídeo online ao vivo',
  ...
  DESS: {
    ...
    features: [
      ...
      'Processo seguro de desmame assistido',
      'Acesso vitalício ao Protocolo MED',
      'Ideal para quem usa medicação',
      'Supervisão clínica intensiva'
    ]
  },
  NEXUS: {
